...
from recognizer import find_whole_song_in_mix
from recognizer import refine_whole_match
from recognizer import chunk_match
...
if __name__ == "__main__":
    ...
    if song_fp is not None and mix_fp is not None:
        ...
        if song_start is not None and song_end is not None:
            print("\n--- 🎵 Final Result 🎵 ---")
            print(f"Hopefully good match! Song Start: {song_start:.2f}, Song End: {song_end:.2f}")
